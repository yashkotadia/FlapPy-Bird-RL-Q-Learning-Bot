...
def main():
    ...
    pygame.display.set_caption('HK Bird') # Set the window name
...
def mainGame(movementInfo):
    ...
    while True:
        ...
        # If player has crashed, return the required information to showGameOverScreen()
        if crashTest[0]:
            return {
                'y': playery,
...
# Returns a list [a, b]; a is true if collision has occured and b is true for base collision and false for pipe collision 
